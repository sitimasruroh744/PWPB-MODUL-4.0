            ...
            <div class ="row">
                <div class="col-md-12">
                    <div class="overview-wrap">
                        ...
                        <button class="au-btn-icon au-btn--blue">
                            <i class="zmdi-plus"></i>i>add item</button>
                        </div>
                    </div>
                </div>
...
<body class="animsition">
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="assets/CoolAdmin-master/images/icon/ava_pajri.jpg" alt="tyong" />
                                        </div>
                                        <div class="content">
                                            <a class="js-acc-btn" href="#">smasruroh</a>
                                        </div>
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                <div class="image">
                                                    <a href="#">
                                                        <img src="assets/CoolAdmin-master/images/icon/ava_pajri.jpg" alt="Taeyong Lee" />
                                                    </a>
                                                </div>
                                                <div class="content">
                                                    <h5 class="name">
                                                        <a href="#">Park Jisung</a>
                                                    </h5>
                                                    <span class="email">smasruroh744@gmail.com</span>
                                                </div>
                                            </div>
    ...
    <!-- <?php //$this->load->("admin/_partials/scrolltop.php") ?> -->
